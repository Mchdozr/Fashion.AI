/*
  ...
  1. Changes
    - Add proper database functions for generation handling
    - Add better status tracking
    - Add proper error handling
    - Add proper task ID handling
...
-- Create or replace the check_generation_status function
...
-- Create or replace the start_generation function
